...
<div class="container">
	...
	<div class="container" align="center">
		...
		<div align="left">
	    	<ul class="list-group">
	      		<li class ="list-group-item font-weight-bold" style="background-color: #33334d;">수주관리</li>
	    	</ul>
		</div>
	  	<br />
	  	<!-- input 버튼 -->
		<div align="right">
			<a href="/takeOrderInputForm.do"><input type="button" value="수주 입력" class="btn btn-primary" style="text-align: center; font-size: 15px"></a>
		</div>
		</br>
		<!-- 내용보기 -->
