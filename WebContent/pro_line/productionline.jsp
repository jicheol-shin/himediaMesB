...
<%
    ...
    ArrayList<Production> productionList = (ArrayList<Production>) request.getAttribute("productionList"); 
%>
<c:set var="production_data" value="<%=productionList %>"/>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	...
	<div class="container" align="center">
		<div align="center">
		 <ul class="list-group class-box" >
            <li class="list-group-item font-weight-bold" style="background-color: #33334d;">공정 관리</li>
		</ul>
	  </div>
	  <br />
	  	...
	  	<thead class="thead-dark" align="center" >
	  		<tr>
					...
					<th>생산완료등록</th>
							...
							<tbody>
				 <c:forEach var="production" items="${production_data}">
					<tr>
