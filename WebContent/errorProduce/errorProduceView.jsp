...
<div class="container">
	...
	<div class="container" align="center">
		...
		<div align="left">
	    	<ul class="list-group">
	      		<li class ="list-group-item font-weight-bold" style="background-color: #33334d;">불량관리</li>
	    	</ul>
		</div>
		<br />
		<!-- input 버튼 -->
		<div align="right">
			<input type="button" value="불량 입력" class="btn btn-primary" style="text-align: center; font-size: 15px">
		</div>
	  	<br />
		<!-- 내용보기 -->
